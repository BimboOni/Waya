    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-center pt-4">
        <button onClick={onClose}
          className="bg-bg-card text-text-primary border-2 border-border-default border-b-4 rounded-full h-12 px-8 text-label-md font-medium transition-all duration-100 hover:bg-bg-secondary/60 active:translate-y-0.5 active:border-b-2 active:scale-[0.98] flex items-center gap-2">
          <IconCheck size={18} />
          Complete Session
        </button>
      </div>
