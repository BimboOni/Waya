            ...
            <div className="flex flex-col gap-5 max-w-md w-full mb-6">
              ...
              <div className="flex flex-row gap-2">
                <button onClick={handleSave} disabled={saving}
                  className="flex-1 bg-brand-primary text-white font-bold rounded-full h-12 px-6 border-b-4 border-brand-hover active:translate-y-[2px] active:border-b-2 active:scale-[0.98] transition-all disabled:opacity-30 disabled:cursor-not-allowed hover:brightness-95">
                  {saving ? 'Saving...' : 'Save Changes'}
                </button>
                <button onClick={() => setIsEditingName(false)}
                  className="flex-1 bg-bg-card border border-border-default border-b-4 text-text-secondary font-medium rounded-full h-12 px-6 active:translate-y-[2px] active:border-b-2 active:scale-[0.98] transition-all hover:brightness-95">
                  Cancel
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-row justify-between items-start w-full gap-4">
            ...
            {!isAddingInterest && (
                <button onClick={openAddInterest}
                  className="bg-bg-card border border-border-default border-b-4 text-text-secondary font-medium rounded-full h-12 px-6 active:translate-y-[2px] active:border-b-2 active:scale-[0.98] transition-all hover:brightness-95 shrink-0">
                  Add Interest
                </button>
            )}
          </div>
